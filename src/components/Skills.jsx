...
const Skills = () => {
  return (
    <div name='skills' className=' w-full h-screen bg-[#457b9d]  text-gray-300' >
        {/* Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div >
                <p className='text-4xl font-bold inline border-b-4 border-[#f4a261]'>Skills</p>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-6'>
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto my-3' src={CSS} alt="CSS icon" />
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto my-3' src={AWS} alt="HTML icon" />
